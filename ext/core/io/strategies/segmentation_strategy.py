...
@LabelingFormatRegistry.register_strategy(SupportedFormats.SEGMENTATION.value)
class SegmentationStrategy(IOStrategy):
    ...
    def ensure_directories(self) -> None:
        ...
        label_dir = join(self.write_cfg.save_path, "segmentation/")
